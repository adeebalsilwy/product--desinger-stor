    ...
    <div class="app-container">
      <aside class="sidebar">
        <div class="nav-item" v-for="item in navItems" :key="item.key">
          <button type="button" class="nav-icon" :class="{ active: item.active }">
            <i :class="item.icon"></i>
          </button>
        ...
        <div class="top-toolbar neumorphic">
          ...
          <div class="toolbar-group">
            ...
            <button class="hero-action preview-btn" @click="showMockup = !showMockup"
              ...
              <span>{{ showMockup ? t('designer.hide_preview', 'إخفاء المجسم') : t('designer.show_preview', 'عرض التصميم
                على المجسم') }}</span>
            </button>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      navItems: [
        { key: 'home', label: 'الرئيسية', icon: 'fas fa-home', active: true },
        { key: 'designs', label: 'تصاميمي', icon: 'fas fa-palette', active: false },
        { key: 'products', label: 'المنتجات', icon: 'fas fa-tshirt', active: false },
        { key: 'panel', label: 'لوحة التحكم', icon: 'fas fa-file-invoice', active: false },
        { key: 'profile', label: 'الملف الشخصي', icon: 'fas fa-user', active: false }
      ],
      tools: [
